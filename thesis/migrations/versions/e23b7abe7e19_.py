...
Revision ID: e23b7abe7e19
Revises: 
Create Date: 2019-11-15 16:17:29.526140
...
def upgrade():
    ...
    sa.Column('major_id', sa.Integer(), nullable=True),
    sa.Column('major_direction_id', sa.Integer(), nullable=True),
    ...
    sa.Column('add_time', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['major_direction_id'], ['majordirection.id'], ),
    sa.ForeignKeyConstraint(['major_id'], ['major.id'], ),
